...
# Environment configuration - only joint control for this environment
env = ReachingFranka(robot_ip="172.16.0.2", device="cpu")
...
# load checkpoints - only joint control available for this environment
